...
app.post('/signup', (req, res) => {
  ...
  connection.query('SELECT * FROM accounts WHERE email = ?', [email], (error, results) => {
    ...
    bcrypt.hash(password, 10, (hashError, hashedPassword) => {
      ...
      connection.query('INSERT INTO accounts (email, password,otp) VALUES (?, ?, ?)', [email, hashedPassword, otp], (insertError) => {
        if (insertError) {
        ...
        const transporter = nodemailer.createTransport({
          service: 'Outlook',
          auth: {
            user: 'MAMC420@outlook.com', // Replace with your Outlook email address
            pass: 'MAMC12345', // Replace with your Outlook password
          },
        });
        ...
        const mailOptions = {
          from: 'MAMC420@outlook.com', // Your email address
...
app.post("/send-email", (req, res) => {
  const { name, email, number, subject, body } = req.body;
  ...
  const mailOptions = {
    from: "MAMC420@outlook.com", // Replace with your Outlook email address
    to: email, // Replace with the recipient's email address
    subject: subject,
    text: body // Use the body as the text content
  };
